...
sudo -H -u duneuser bash -c "yay -Sy zoom --noconfirm"
sudo -H -u duneuser bash -c "yay -Sy whatsdesk-bin --noconfirm"
sudo -H -u duneuser bash -c "yay -Sy emacs-native-comp-git --noconfirm"
